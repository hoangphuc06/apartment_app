        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _textformField(_depositController, "Nhập tiền cọc", "tiền cọc"),
              SizedBox(
                height: 30,
              ),
              ...
              GestureDetector(
                  ...
                  child: AbsorbPointer(
                      child: _textformField(_nameRenter, "Chọn người thuê nhà",
                          "người thuê nhà"))),
              SizedBox(
                height: 30,
              ),
        ...
        child: Column(
          ...
          children: [
            TextFormField(
              ...
              minLines: 3,
              decoration: InputDecoration(
                  border: InputBorder.none, hintText: "Điều khoản chung"),
              style:
        ...
        child: Column(
          ...
          children: [
            TextFormField(
              ...
              minLines: 3,
              decoration: InputDecoration(
                  border: InputBorder.none, hintText: "Điều khoản bên A"),
              style:
                  TextStyle(color: Colors.black, fontWeight: FontWeight.w400),
            ),
            SizedBox(
        ...
        child: Column(
          ...
          children: [
            TextFormField(
              ...
              minLines: 3,
              decoration: InputDecoration(
                  border: InputBorder.none, hintText: "Điều khoản bên B"),
              style:
                  TextStyle(color: Colors.black, fontWeight: FontWeight.w400),
            ),
            SizedBox(
