      ...
      Step(
        ...
        content: Column(
          ...
          children: [
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if (!snapshot.hasData) {
                    ...
                    return Column(
                      crossAxisAlignment:  CrossAxisAlignment.start,
                      children: [
                        _titletext("Tiền khách nợ"),
                        SizedBox(height: 10,),
                        _detail("Tiền chốt dịch vụ cuối", "1000000 VNĐ"),
                        SizedBox(height: 30,),
                        _titletext("Tiền trả khách"),
                        SizedBox(height: 10,),
                        _detail("Tiền chốt dịch vụ cuối", "1000000 VNĐ"),
                        SizedBox(height: 10,),
                        _detail("Tiền phòng", "1000000 VNĐ"),
                        SizedBox(height: 10,),
                        _detail("Tiền dịch vụ", "1000000 VNĐ"),
                        SizedBox(height: 10,),
                        _detail("Tiền cọc", "1000000 VNĐ"),
                        SizedBox(height: 30,),
            ...
            _titletext("Tổng hợp"),
            SizedBox(height: 10,),
            _detail("Tiền khách nợ", "1000000 VNĐ"),
            SizedBox(height: 10,),
            _detail("Tiền trả khách", "1000000 VNĐ"),
            SizedBox(height: 10,),
            _titletextblack("Tiền phạt"),
            SizedBox(height: 10,),
            _nameTextFormField(),
            SizedBox(height: 10,),
            _titletextred("Giảm giá (%)"),
            SizedBox(height: 10,),
            _nameTextFormField(),
            SizedBox(height: 10,),
            _detailtotal("Thanh toán", "1000000 VNĐ"),
            SizedBox(height: 30,),
            _titletext("Ghi chú"),
            SizedBox(height: 10,),
            _note(),
