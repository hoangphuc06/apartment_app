...
class _DwellerSearchTabState extends State<DwellerSearchTab> {
  ...
  bool _filter(DwellerModel temp){
    if((!check||!temp.check())&&
                ...
                child: StreamBuilder(
                    ...
                    builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                      ...
                      snapshot.data!.docs.forEach((element) {
                        DwellerModel temp= DwellerModel.fromDocument(element);
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return DwellerCard(dweller: this.Cache[index], funtion: (){
                              Route route = MaterialPageRoute(builder: (context) => DwellerDetailPage(dweller: this.Cache[index], ));
